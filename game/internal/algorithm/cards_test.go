...
func TestCards_Straight(t *testing.T) {
	...
	//cards := Cards{0x02, 0x29, 0x36, 0x08, 0x0a, 0x1d, 0x17}  // 顺子 后
	cards := Cards{0x2e, 0x32, 0x34, 0x25, 0x23, 0x37, 0x28}  // 顺子 后
	//cards := Cards{0x0e, 0x02, 0x03, 0x04, 0x2e, 0x05, 0x28}  // 顺子 后
	...
	//cards := Cards{0x02, 0x24, 0x06, 0x0e, 0x09, 0x0c, 0x3d} // 同花2
	//cards := Cards{0x24, 0x3c, 0x25, 0x26, 0x04, 0x27, 0x28}
